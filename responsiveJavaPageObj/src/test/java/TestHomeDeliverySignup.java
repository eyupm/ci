...
public class TestHomeDeliverySignup {
	...
	public void openHomepage() {
		...
		*/
		...
		// For Page Object
		OpenURL OpenURL = new OpenURL(driver); // Create Instant
		
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='txtZip']")));
		OpenURL.OpenHomePage();    // Call 
	...
	public void enterZipCode() {
		...
		// Page Object Method Section
		
		OpenURL OpenURL = new OpenURL(driver);
		OpenURL.enterZipCode("02116");
	...
	public void enterDetails() {
        ...
        OpenURL.enterDetails("Patrick", "McCartney", "28 Main St","Apt. 2", "781", "847", "4433", "patrickm@perfectomobile.com");
